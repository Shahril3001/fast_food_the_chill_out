	  ...
	  $("#HappyHourbtn").click(function(){
		...
		$("#HappyHourtab").show();
			...
			<div class="row">
							...
							echo"<div id='cart'><a href='login.php'><img src='images/cart.png' alt='' height='45px' width='50px'></a></div>";
							foreach($categories as $category){
								echo"<div class='menudetail1' id='".$category."tab'>";
					...
					<div><center><a href='$productImage'><img style='border-radius:10px;' src='$productImage' alt='' height='230px' width='220px'></a></center></div>
					<div class='product-name'>$productName</div>
					<div class='product-price'>BND$$productPrice</div>
					<a href='login.php'><button id='buttonclick' class='button'>ORDER</button></a>
					</div>
