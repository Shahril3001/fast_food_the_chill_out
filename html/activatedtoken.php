		...
		<center>
			...
			<?php
				if(isset($_GET['memberIC'])&& isset($_GET['role'])){
					...
					echo"
					<table id='formtable'>
						<form method='POST' action='activatedtoken2.php?memberIC=".$memberIC."&role=".$role."'>
									<tr>
										<th colspan='2'>Member Activation</th>
									</tr>
									<tr>
										<td>Token:</td>
										<td><input type='text' name='tokenserial' size='35' ></td>
									</tr>
									<tr>
										<td style='border:none;' colspan='2'  id='buttonrow'><input id='buttonclick' type='submit' name='Submit' value='Submit'/>
										<input id='buttonclick1' type='button' name='back' value='Back' onclick='goBack()'></td>
									</tr>
								</form>
								</table>
								";
