	...
	<section class="section-chef bgwhite p-t-115 p-b-95">
		<div class="container">
			...
			<?php
					...
					echo"
					<form method='POST' id='formpage' enctype='multipart/form-data' action='addproduct2.php?adminemail=".$adminemail."&role=".$role."'>";
			?>
								<table id="formtable">
									<tr>
									...
									<tr>
										...
										<td><textarea id='editor1' name="productingredient"></textarea></td>
									</tr>
									<tr>
										<td><b>Product Price:</b></td>
										<td><input type="text" class="memberprofile" name="productprice"></td>
									</tr>
									<tr>
