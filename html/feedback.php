...
<body class="animsition">
	...
	<section class="section-chef bgwhite p-t-115 p-b-95">
		<div class="container">
			...
			<div class="row">
							<form method="POST" action="feedback2.php" id="formpage">
								<table id="formtable">
									<tr>
									...
									<tr>
										<td><b>Username:</b></td>
										<td><input type="text" name="fbusername" size='25' placeholder="Your name..." required></td>
									</tr>
									<tr>
										<td><b>Subject:</b></td>
										<td><input type="text" name="fbsubject" size='25' placeholder="Your subject..." required></td>
									</tr>
									<tr>
										<td><b>Email:</b></td>
										<td><input type="email" name="fbemail" size='25' placeholder="Your email..." required></td>
									</tr>
									<tr>
										<td><b>Comment:</b></td>
										<td><textarea name="fbcomment"  id='editor1' rows='5' cols='40%' placeholder="Your comment.." required></textarea></td>
									</tr>
									<tr>
