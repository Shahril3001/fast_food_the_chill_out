		...
		<center>
			...
			<?php
				if(isset($_GET['adminemail'])&& isset($_GET['role'])){
					...
					<table id='formtable'>
						<form method='POST' action='updateadmin2.php?adminemail=".$adminemail."&role=".$role."'>
									<tr>
										<th colspan='2'>Edit Profile</th>
									</tr>
									<tr>
										<td width='240px'><b>Username:</b></td>
										<td><input type='text' name='newadminname' size='35' value='$adminname'></td>
									</tr>
									<tr>
										<td><b>Phone:</b></td>
										<td><input type='number' class='memberprofile' size='35' name='newadminphone' value='$adminphone'></td>
									</tr>
									<tr>
										<td><b>Email:</b></td>
										<td><input type='text' size='35' value='$adminemail' readonly></td>
									</tr>
									<tr>
										<td><b>New Password:</b></td>
										<td><input type='password' name='newadminpassword' size='35'  value='$adminpassword'></td>
									</tr>
									<tr>
										<td><b>Confirm Password:</b></td>
										<td><input type='password' name='newcadminpassword' size='35' value='$adminpassword'></td>
									</tr>
									<tr>
