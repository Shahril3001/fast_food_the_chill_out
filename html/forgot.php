    ...
    $("#btn2").click(function(){
		...
		$("#studenttab").hide();
			...
			<div class="row">
							...
							<form method="POST" action="forgotmember.php">
								<table id="formtable">
									<tr>
									...
									<tr>
										<td>Member Phone</td>
										<td><input type="number" name="memberphone" required></td>
									</tr>
									<tr>
										<td>Member Email</td>
										<td><input type="text" name="memberemail" required></td>
									</tr>
									<tr>
							...
							<form method="POST" action="forgotadmin.php">
								<table id="formtable">
									<tr>
									...
									<tr>
										...
										<td><input type="number" name="adminphone" required></td>
									</tr>
									<tr>
										<td>Employee Email</td>
										<td><input type="text" name="adminemail" required></td>
									</tr>
									<tr>
