	...
	<section class="section-chef bgwhite p-t-115 p-b-95">
		<div class="container">
			...
			<?php
					...
					$query = dbConn()->prepare("SELECT * FROM product where productName LIKE '%".$productname."%' AND productCategory LIKE '%".$productcategory."%'");
					$query->execute();
					$products = $query->fetchAll(PDO::FETCH_OBJ);
					$num_count = $query->rowCount();
					$categories=['Lunch','Sides','Dinner','Drink','Dessert','HappyHour'];
			echo"<div id='searchform'><form method='POST' action='searchproduct.php?adminemail=".$adminemail."&role=".$role."'><p><input type='text' name='productname'  placeholder='Search..'> 	<select name='productcategory'>";
