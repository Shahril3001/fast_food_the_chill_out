	...
	<section class="bg1-pattern p-t-120 p-b-105">
		<div class="container">
			...
			?>
				...
				<?php echo"<h3>WELCOME ".strtoupper($membername)."</h3></br>
			...
			<?php
				...
				<table id='formtable'>
									...
									<tr>
										<td style='border:none;' colspan='2'  id='buttonrow'><a href='updatemember.php?memberIC=".$memberIC."&role=".$role."'><button id='buttonclick' class='button'>Edit Profile</button></a>
										...
										if($memberStatus=="Activated"){
											...
											echo"<a href='activatedtoken.php?memberIC=".$memberIC."&role=".$role."'><button id='buttonclick' class='button'>Activated Token</button></a>";
										}
										echo"</td>
									</tr>
								</table>";
