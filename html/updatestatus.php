...
<html lang="en">
<head>
	<title>Update Member Status</title>
	<meta charset="UTF-8">
	...
	<section class="section-chef bgwhite p-t-115 p-b-95">
		...
		<center>
			...
			<?php
				...
				if(isset($_GET['adminemail'])&&isset($_GET['memberIC'])&& isset($_GET['role'])){
					...
					echo"
					<table id='formtable'>
						<form method='POST' action='updatestatus2.php?adminemail=".$adminemail."&memberIC=".$memberIC."&role=".$role."'>
									<tr>
										<th colspan='2'>Member Activation</th>
									</tr>
									<tr>
										<td><b>Member Status:</b></td>
										<td><select name='newmemberstatus'>
