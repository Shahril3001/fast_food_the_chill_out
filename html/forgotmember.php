...
<html lang="en">
<head>
	<title>Forgot Page (Member)</title>
	<meta charset="UTF-8">
	...
	<section class="section-chef bgwhite p-t-115 p-b-95">
		<div class="container">
			...
			<h3>
				...
				$query = dbConn()->prepare("SELECT * FROM member where memberphone LIKE '%".$memberphone."%' AND memberemail LIKE '%".$memberemail."%'");
				$query->execute();
				...
				foreach($members as $member){
					...
					echo"<table id='formtable'>
						...
						<tr>
							<td width='240px'>User IC Number:</td>
							<td>$memberIC</td>
						</tr>
						<tr>
							<td>Phone:</td>
