	...
	<section class="bg1-pattern p-t-120 p-b-105">
		<div class="container">
			...
			<?php
					...
					$orderlistquery = dbConn()->prepare('SELECT * FROM orderdetail WHERE memberIC="'. $memberIC .'"');
			...
			<div class='row'>
				<table id='listtable'>
					...
					<p><a href='orderdetail.php?memberIC=".$memberIC."&orderkeyID=".$orderkeyID."&role=".$role."'><button id='buttonclick' class='button'>Order List</button></a></p>
					<p><a href='deleteorder.php?memberIC=".$memberIC."&orderkeyID=".$orderkeyID."&role=".$role."'><button id='buttonclick1' class='button'>Delete</button></a></p>
					</center>
					</td>
					</tr>";
					}
