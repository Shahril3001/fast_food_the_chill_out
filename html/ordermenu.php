	...
	<section class="bg1-pattern p-t-120 p-b-105">
		<div class="container">
			...
			<?php
				...
				echo"<form method='POST' action='ordermenu2.php?productID=".$productID."&memberIC=".$memberIC."&role=".$role."' id='formpage'>	
					<table id='formtable'>
					<tr>
					...
					<tr>
						<td><b>Quantity:</b></td>
						<td><input type='number' size='35' name='cartquantity'></td>
					</tr>
					<tr>
						<td style='border:none;' colspan='2'  id='buttonrow'><input id='buttonclick' class='button' type='submit' name='Submit' value='Order'/>
