...
<body class="animsition">
	...
	<section class="bg1-pattern p-t-120 p-b-105">
		<div class="container">
			...
			?>
			<center>
				<?php echo"<h3>WELCOME ".strtoupper($adminname)."</h3></br>
			...
			<?php
				...
				<table id='formtable'>
									...
									<tr>
										<td style='border:none;' colspan='2'  id='buttonrow'><a href='updateadmin.php?adminemail=".$adminemail."&role=".$role."'><button id='buttonclick' class='button'>Edit Profile</button></a></td>
									</tr>
								</table>";
			}
			?>
